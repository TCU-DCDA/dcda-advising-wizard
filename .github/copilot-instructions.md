...
## Project Overview
A **React 19 + TypeScript + Vite** PWA for TCU DCDA degree planning. Mobile-first wizard interface that guides students through two phases: recording completed coursework (Part 1) and scheduling future courses (Part 2).
...
└── steps/               # Individual wizard screens
    ...
    └── ReviewStep.tsx   # Final summary with PDF/CSV export
```
