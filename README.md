...
*   **Updating Offerings:** From `addran-course-scraper/`, run `node scrape.mjs -t "Fall 2026" -a DCDA --all-sections -o ../dcda-advising-wizard/data/offerings-fa26.json`. Then update the import in `services/courses.ts` to point to the new file.
